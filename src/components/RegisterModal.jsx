...
const RegisterModal = ({ isOpen, onClose, onSwitchToLogin }) => {
  ...
  const handleGoogleSuccess = (userData) => {
    ...
    alert(`Chào mừng ${userData.username} đến với Thư Viện Web!`);
  };
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-300">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md transform transition-all animate-in zoom-in-95 duration-300 max-h-[90vh] overflow-y-auto">
        ...
        {/* Body */}
        <div className="p-8">
          {/* Google Registration - Moved to top */}
          <div className="mb-8">
            <GoogleLoginButton 
          ...
          <div className="mb-8 flex items-center">
            ...
            <span className="px-4 text-sm text-gray-500 bg-white">hoặc tạo tài khoản với email</span>
            <div className="flex-1 border-t border-gray-200"></div>
          </div>
